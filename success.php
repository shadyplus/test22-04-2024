        ...
        <div class="main">
            ...
            <div class="header">
                ...
                <div class="header__subtitle">
                    <p id="subtitle">Notre responsable vous contactera bientôt pour confirmation</p>
                </div>
            </div>
            <div class="user-info">
                <div class="user-info__item">
                    <p> <span id="name">Votre nom: </span> <span class="user-info__name"><?=$name?></span></p>
                </div>
                <div class="user-info__item">
                    <p><span id="phone">Numéro de téléphone: </span> <span class="user-info__phone"><?=$phone?></span></p>
                </div>
            </div>
            ...
            <div class="subscribe" id="block">
                <div class="subscribe__cta">Bénéficiez d'une remise permanente de 50% sur votre prochain achat !</div>
                <form id="subscribe__form" class="subscribe__input" action="/subscribe" method="post">
                    <input type="email" name="email" placeholder="Entrer votre Email" autocomplete="email"
                        required>
                    <button type="submit" id="next">
                        <span class="subscribe__submit-text">S'abonner</span>
            ...
            <div class="reviews">
                <div class="reviews__item">
                    ...
                    <div class="reviews__body">
                        <div class="reviews__info">
                            <span class="reviews__name">Sophie</span>
                ...
                <div class="reviews__item">
                    ...
                    <div class="reviews__body">
                        <div class="reviews__info">
                            <span class="reviews__name">Juliette</span>
                            <div class="reviews__stars"></div>
                            <span class="reviews__date"><span class="date-0"></span></span>
                        </div>
                        <div class="reviews__text">
                            <p>Tout reçu, je suis content</p>
                        </div>
                    </div>
                </div>
                <div class="reviews__item">
                    ...
                    <div class="reviews__body">
                        <div class="reviews__info">
                            <span class="reviews__name">Jean</span>
                            <div class="reviews__stars"></div>
                            <span class="reviews__date"><span class="date-1"></span></span>
                        </div>
                        <div class="reviews__text">
                            <p>Je l'ai essayé, je le recommande à tout le monde !</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function sendAjaxForm(result_form, forms, url) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('.subscribe__cta').append('Merci de confirmer votre accord par mail'); // тут меняем
                },
                error: function (response) {
                    $('.subscribe__cta').append("'Erreur Aucune information n'a été envoyée."); // тут меняем
                }
            });
        }
    </script>
